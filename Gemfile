...
group :system_test do
  ...
  gem 'beaker', '>= 3.21.0', *location_for(ENV['BEAKER_VERSION'] || beakerver)
  gem 'beaker-abs', '>= 0.3.0', *location_for(ENV['BEAKER_ABS_VERSION'])
  gem 'beaker-hostgenerator',                          *location_for(ENV['BEAKER_HOSTGENERATOR_VERSION'])
  gem 'beaker-pe',                                     require: false
  gem 'beaker-rspec', '>= 6.2.0', *location_for(ENV['BEAKER_RSPEC_VERSION'])
